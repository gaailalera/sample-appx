            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <form action="{{ route('products.update', $product) }}" method="POST">
                            ...
                            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <input type="text" name="controlNumber" id="controlNumber" value="{{ $product->controlNumber }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type user name" required="" >
                ...
                <div class="col-span-2 sm:col-span-1">
                    ...
                    <x-input-error class="mt-2" :messages="$errors->get('timeReceived')" />
                                ...
                                <input type="date" name="dateReleased" value="{{ $product->dateReleased}}" id="dateReleased" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"  required="" >
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="initialReceived" id="initialReceived" value="{{ $product->initialReceived }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type initial Received" required="" >
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="trackingNumber" id="trackingNumber" value="{{ $product->trackingNumber }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type tracking number" required="" >
